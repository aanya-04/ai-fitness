  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="gap-2 w-full sm:w-auto bg-gradient-to-r from-fuchsia-700 via-pink-500 to-yellow-400 text-blue rounded-xl shadow-lg hover:brightness-110 transition-all">
      ...
      <DialogContent className="sm:max-w-md bg-neutral-900/80 backdrop-blur-xl border border-neutral-700 rounded-2xl shadow-2xl p-6 text-white">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold bg-gradient-to-r from-fuchsia-700 via-pink-500 to-yellow-400 bg-clip-text text-transparent">
            🎧 Hear Your Plan
          </DialogTitle>
        ...
        <div className="space-y-5 py-4">
          ...
          <div className="flex flex-col gap-3">
            {!isPlaying ? (
              <Button
                onClick={speak}
                className="w-full py-4 rounded-xl bg-gradient-to-r from-fuchsia-700 via-pink-500 to-yellow-400 hover:brightness-110 text-white font-semibold shadow-lg"
              >
              ...
              <div className="flex gap-3">
                <Button
                  ...
                  className="flex-1 py-4 bg-blue-400 hover:bg-blue-500 text-white rounded-xl shadow-md"
                >
                  {isPaused ? (
                    <>
                      <Play className="mr-2 h-5 w-5" />
                ...
                <Button
                  onClick={stop}
                  className="flex-1 py-4 bg-red-500 hover:bg-red-600 text-white rounded-xl shadow-md"
                >
          ...
          {/* Status Bar */}
          {isPlaying && (
            <div className="p-4 bg-fuchsia-600/10 border border-pink-500 rounded-xl text-center shadow-inner">
              <div className="flex justify-center items-center gap-2">
                <Volume2 className="h-5 w-5 text-yellow-400 animate-pulse" />
                <span className="font-semibold text-pinnk-300">
          ...
          {/* Info Box */}
          <div className="p-4 bg-pink-600/10 border border-fuchsia-500 rounded-xl shadow-inner">
            <p className="text-sm text-pink-300">
              Your AI plan speaks — zero setup, zero keys.
            </p>
          </div>
        </div>
