  ...
  return (
    <div className="w-full mx-auto space-y-6" id="fitness-plan">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            AI-Powered Workout & Nutrition Plan
          </p>
        </div>
      ...
      <div id="fitness-plan-content" className="space-y-8">
        ...
        {/* Motivation Section */}
        <section className="py-6 px-4 bg-gradient-to-r from-fuchsia-500 via-pink-500 to-yellow-600 dark:from-fuchsia-700 dark:to-yellow-500 rounded-lg text-white shadow-lg">
        ...
        <section className="space-y-4">
          <div className="border-b-2 border-pink-500 pb-3 mb-6">
            <div className="flex items-center gap-3">
              <Dumbbell className="h-8 w-8 text-yellow-400 dark:text-pink-400" />
          ...
          <div className="space-y-5">
            {plan.workoutPlan.map((day, idx) => (
              <Card 
                key={idx}
                className="border-2 border-pink-200 dark:border-pink-700 hover:border-pink-400 dark:hover:border-pink-500 transition-colors bg-white dark:bg-slate-800"
              >
                <CardHeader className="bg-pink-50 dark:bg-pink-900 py-4">
                  ...
                  <div className="space-y-4">
                    {day.exercises.map((exercise, exIdx) => {
                      ...
                      return (
                        <div
                          key={exIdx}
                          className={`p-4 bg-gray-50 dark:bg-slate-700 border-l-4 border-pink-500 rounded-lg hover:bg-pink-50 dark:hover:bg-slate-600 transition-all ${
                            isExpanded ? 'ring-2 ring-pink-300 dark:ring-pink-500' : ''
                          }`}
                        >
                          ...
                          <div className="grid grid-cols-3 gap-3 text-sm mb-3">
                            <div className="bg-white dark:bg-slate-600 p-2 rounded border border-gray-300 dark:border-slate-500">
                              <span className="font-semibold text-pink-600 dark:text-pink-400">Sets:</span>
                              <p className="text-gray-900 dark:text-white">{exercise.sets}</p>
                            </div>
                            <div className="bg-white dark:bg-slate-600 p-2 rounded border border-gray-300 dark:border-slate-500">
                              <span className="font-semibold text-pink-600 dark:text-pink-400">Reps:</span>
                              <p className="text-gray-900 dark:text-white">{exercise.reps}</p>
                            </div>
                            <div className="bg-white dark:bg-slate-600 p-2 rounded border border-gray-300 dark:border-slate-500">
                              <span className="font-semibold text-pink-600 dark:text-pink-400">Rest:</span>
